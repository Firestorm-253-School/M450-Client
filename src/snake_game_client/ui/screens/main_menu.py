...
class MainMenu(Screen):
  ...
  def __init__(self, screen, game):
    ...
    highscore_button = Button(((screen.get_width() / 2) - 100, (screen.get_height() / 2) + 160, 200, 60), "Highscores", lambda: game.ui.change_screen(
        'highscore'))
    quit_button = Button(((screen.get_width() / 2) - 100, (screen.get_height() / 2) + 240, 200, 60), "Quit",
                         lambda: game.quit(), (255, 0, 0))
